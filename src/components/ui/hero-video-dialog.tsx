...
export function HeroVideoDialog({
  ...
  // Check if thumbnailSrc is a video file
  const isVideoThumbnail = thumbnailSrc.match(/\.(mp4|webm|ogg)$/i);
      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button
                className="absolute -top-16 right-0 rounded-full bg-neutral-900/50 p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black hover:bg-neutral-800/60 transition-colors duration-200"
                onClick={() => setIsVideoOpen(false)}
