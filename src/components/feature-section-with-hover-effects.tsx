...
export function FeaturesSectionWithHoverEffects() {
  const features = [
    ...
    },
    {
      title: "History",
      description:
        "Our AI remembers your past interactions, personalizing future questions and feedback for continuous improvement.",
      icon: <MdHistory className="h-7 w-7" />,
    },
    {
      title: "Voice Interaction ",
      description:
        "Practice with natural voice input and receive AI questions audibly, enhancing your realistic interview experience.",
    ...
    },
    {
      ...
      description:
        "See what skills you have vs what's required, along with percentage match & improvement suggestions.",
      icon: <MdCompare className="h-6 w-6" />,
    },
  ];
  return (
    <div className="pt-12 Steps">
